-- 101: Add jobs_active_public to admin_stats (customer-visible /jobs listings).
-- Supersedes partial 099_admin_stats_job_review_counts when that file was skipped
-- due to duplicate migration number (099_match_dismiss_note applied first).
